  ...
  return function b(a, c, d) {
    ...
    4: [function(b, c, d) {
      ...
      function g(a, b, c, d, e) {
        var f = b.contentWindow,
          ...
          l = new o(c, g),
          n = v(a),
          q = "view" === c.type ? d : j(f.document),
          s = "view" === c.type ? e : k(f.document),
          t = new c.renderer(q, s, l, c, document),
          u = new p(a, t, g, l, c);
      ...
      function i(a, b) {
        ...
        return c.width = b.width, c.height = b.height, r("Cropping canvas at:", "left:", b.left, "top:", b.top, "width:", e - d, "height:", g - f), r("Resulting crop with width", b.width, "and height", b.height, " with x", d, "and y", f), c.getContext("2d").drawImage(a, d, f, e - d, g - f, b.x, b.y, e - d, g - f), c
      }
    ...
    14: [function(a, b, c) {
      ...
      d.prototype.cloneTo = function(a) {
        ...
        if (g(f[0])) d = a.width * parseFloat(f[0]) / 100;
        else {
          if (/contain|cover/.test(f[0])) {
            var h = a.width / a.height,
              i = b.width / b.height;
            return i > h ^ "contain" === f[0] ? {
              width: a.height * i,
              height: a.height
            } : {
              width: a.width,
        ...
        if (!this.transformData)
          if (this.hasTransform()) {
            var a = this.parseBounds(),
              b = this.prefixedCss("transformOrigin").split(" ").map(h).map(i);
    ...
    15: [function(a, b, c) {
      ...
      d.prototype.calculateOverflowClips = function() {
        ...
        var b = P.ucs2.decode(a.node.data),
          ...
          d = a.parent.fontWeight(),
          e = a.parent.css("fontSize"),
          f = a.parent.css("fontFamily"),
