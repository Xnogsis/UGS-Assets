    ...
    ! function(e) {
      ...
      var i = function() {
        ...
        return e.touch = function() {}, e.getRelevantSdkVersion = function() {
          ...
          if ("fbav" === t[1].toLowerCase() && (t[1] = "facebook", t[2])) return "facebook " + t[2];
      ...
      var t = e.store.GAStore,
        ...
        f = function() {
          ...
          return n.addSessionStartEvent = function() {
            ...
            var d = [];
            if (d.push(["status", r.Equal, a]), e === u.Ok) t.delete(i.Events, d), o.i("Event queue: " + c + " events sent.");
            else if (e === u.NoResponse) {
              var l = [];
              l.push(["status", "new"]), o.w("Event queue: Failed to send events to collector - Retrying next time"), t.update(i.Events, l, d)
            } else {
              if (s) {
                var f, v = 0;
                for (var g in s) 0 == v && (f = s[g]), ++v;
                e === u.BadRequest && f.constructor === Array ? o.w("Event queue: " + c + " events sent. " + v + " events failed GA server validation.") : o.w("Event queue: Failed to send events.")
    ...
    var n = e.threading.GAThreading,
      ...
      l = function() {
        ...
        return l.init = function() {
          ...
          return void 0 === n && (n = !0), void 0 === i && (i = ""), i && (i += ": "), e && !r.isInitialized() ? (n && t.w(i + "SDK is not initialized"), !1) : !(e && !r.isEnabled()) || (n && t.w(i + "SDK is disabled"), !1)
        }, l
      }();
